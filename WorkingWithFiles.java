...
static int totalMoney =0;
	...
	public static void showResult()
	{
		try
		{
			...
			pw.println("Room Count :" +roomCount);
			if(!(thingSee.equals("")))
			{
				for(int i=0;i<=7;i++)
				{
			...
			System.out.println("do you want to view the history of the game : yes/no ");
			response = darkly.next();
